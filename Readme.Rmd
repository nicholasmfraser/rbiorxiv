...
Or install the development version from Github (using the [devtools](https://cran.r-project.org/web/packages/devtools/index.html) package):
...
Contributors are welcome, and agree to abide by the [contributor code of conduct](https://github.com/nicholasmfraser/rbiorxiv/blob/master/CODE_OF_CONDUCT.md).
